...
<head>
  ...
  <link rel="icon" type="image/x-icon" href="icon.png">
	...
	<link rel="stylesheet" type="text/css" href="donate_history_admin.css">
...
if(isset($_POST['dnt_hstr'])){   


$query = "SELECT * FROM `donation_list`";
    ...
    <table>
      ...
      <thead>
        <tr>
          ...
          <th scope="col">Donation Field</th>
      ...
      while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
       ?> 
        ...
        <tr>
          ...
          <td data-label="Due Date"><?php echo $row['Donor_Name']; ?></td>
